...
<img class="card__image" src="" onerror="this.onerror=null; this.src='./images/image__error.jpg';"  alt="Извините, фото не найдено"></div>
...
export const commitInner = `<h6 class="carousel__data"></h6>
